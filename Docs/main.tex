...
\begin{document}
    ...
    \include{Chapters/schematics}
    \include{Chapters/analyzer_desctiption}
    \include{Chapters/ADC_description}
    \include{Chapters/communication}
    \include{Chapters/gui}
    \include{Chapters/Core_tasks}
    \include{Chapters/Analog_partTest}
    \include{Chapters/digital_test}
